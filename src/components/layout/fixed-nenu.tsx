...
export default function FixedMenu({ setPagina }: HeaderProps) {
  ...
  return (
    <div
      className="z-[1] w-full flex justify-center"
      style={{ position: "absolute", top: 0 }}
    >
      <nav className=" flex justify-center items-center p-4 h-[80px] w-full">
          ...
          <ul className="flex items-center justify-between hd:w-[35%] xl:w-[45%]">
            ...
            <li>
              <a href="#" onClick={mostrarContato}>
                <span className="tracking-[1px] text-[#333333]">Fale Conosco</span>
              </a>
            </li>
            <li>
              <a href="#" onClick={mostrarSobre}>
                <span className="tracking-[1px] text-[#333333]">Quem Somos</span>
              </a>
            </li>
          </ul>
